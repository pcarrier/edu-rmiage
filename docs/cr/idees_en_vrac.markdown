...
- Messages type E-mail : un utilisateur peut envoyer un mail à 1..N utilisateurs quelconques.
- Messages type IM : un utilisateur peut envoyer un message à une personne de son agenda.
