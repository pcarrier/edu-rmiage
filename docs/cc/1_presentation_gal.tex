...
% TODO description serveur
 TODO description serveur
L'application témoin serveur seras basée sur notre framework ainsi que la technologie RMI. Il implémentera des spécialisations des objets génériques du framework, permettant une gestion d'utilisateurs, par groupes et permissions.
...
%Différentes actions seronts possibles, telle que l'envois de messages, le partage de fichier.
%Les utilisateurs pourront joindres des groupes, privés ou publics.
